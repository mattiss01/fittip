...
- `docs/backlog/M1-01-TRAINING-RECORDS-FOUNDATION.md` — defines the approved
...
- `docs/validation/M1-01-VALIDATION.md` — persists this builder manifest,
...
- `docs/backlog/M0-05-PRIVACY-SAFE-INSTRUMENTATION-AI-CONTROLS.md`
- `docs/backlog/M0-06-QUALITY-DEPLOYMENT-BASELINE.md`
- `docs/backlog/M0-06A-FOUNDER-HOSTED-STAGING.md`
- `docs/backlog/M0-M1-BACKLOG.md`
- `docs/backlog/M1-05-M1-VALIDATION-SLICE.md`
- `docs/backlog/M2-BACKLOG.md`
...
- `docs/backlog/M2-03-INTAKE-FACT-REVIEW.md`
- `docs/backlog/M2-04-M2-VALIDATION-SLICE.md`
- `docs/backlog/M3-01-LOCAL-AI-ADAPTER-CONTROLS.md`
- `docs/backlog/M3-02-ROADMAP-PROPOSAL.md`
- `docs/backlog/M3-03-SELECTED-HORIZON-PLAN-PROPOSAL.md`
- `docs/backlog/M3-04-PLAN-EDIT-LOCK-ACCEPTANCE.md`
- `docs/backlog/M3-05-M3-VALIDATION-SLICE.md`
- `docs/backlog/M3-BACKLOG.md`
