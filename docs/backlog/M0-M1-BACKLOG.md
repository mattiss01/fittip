...
**Planning state:** M0 foundation, M0-01, and M0-02 are accepted. M0-02-C1 is testable after builder completion and independent review, and awaits product-owner acceptance. M0-03 remains draft until both the correction is accepted and the product owner approves its revised F-001 feature brief. Every later ticket remains blocked until its dependencies and linked approval gate are satisfied.
...
| P0 | [M0-02-C1 Remove username](M0-02-C1-REMOVE-USERNAME.md) | testable | M0-02 accepted and ADR-004 | Correct the local-only profile schema, repository, tests, generated types, and governing docs while preserving RLS and ownership | Product owner approved removal on 23 July 2026; `gpt-5.6-terra` builder and independent review passed at `6de981d`; product-owner acceptance requested; remote changes remain prohibited |
