...
**Planning state:** M0 foundation and M0-01 are approved. M0-01 is ready for implementation but is not yet in development. Every other ticket remains blocked until its dependencies and linked approval gate are satisfied.

| Priority | Ticket | Status | Depends on | Scope | Approval gate |
|---|---|---|---|---|---|
| P0 | [M0-01 Repository/tooling baseline](M0-01-REPOSITORY-TOOLING-BASELINE.md) | approved | ADR-001 | Next.js setup, strict TypeScript, lint, format, unit-test and production-build commands | Approved by product owner on 22 July 2026 |
