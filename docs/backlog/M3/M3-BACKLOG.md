...
| P1 | [M3-15B Today and logging](M3-15B-TODAY-AND-LOGGING.md) | proposed | M3-19 accepted | Restore `/home/today` and `/home/log`, the logging path onto M3-15A's write function including **skip**, the first `readPlanWindowToppedUp` caller, and `completedKept` on the series receipt | Tier 2. Draft the exact contract and separately approve dispatch |
