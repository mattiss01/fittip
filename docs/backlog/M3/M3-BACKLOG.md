...
| P1 | [M3-15C Progress](M3-15C-PROGRESS.md) | in development | M3-15B accepted | Restore `/home/progress` and `/home/progress/[id]`: a calendar month of the training record, and one completion beside the immutable planned snapshot it was measured against | Tier 2. Agent brief written 31 Aug 2026 against the product owner scope decisions of that date: completions only, no computed figures. Dispatch approved by the product owner on 31 Aug 2026; builder spawned onto `ticket/m3-15c-progress` the same day. Plan change history split out as M3-24 |
