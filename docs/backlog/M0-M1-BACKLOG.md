...
**Planning state:** M0 foundation, M0-01, M0-02, and M0-02-C1 are accepted. The reduced basic-auth M0-03 implementation and independent review passed and the ticket is testable pending product-owner acceptance. Account recovery is separated into proposed M0-03B and remains required before external MVP use. Every later ticket remains blocked until its dependencies and linked approval gate are satisfied.
...
| P0 | [M0-03 Basic public account authentication](../product/F-001-PUBLIC-ACCOUNT-AUTHENTICATION.md) | testable | M0-02-C1 accepted and ADR-005 | Email/password signup, local email confirmation, profile creation, sign-in/sign-out, sessions, protected route, and authorization tests | Implementation and independent review passed on 26 July 2026; product-owner acceptance requested; hosted and recovery work remain prohibited |
