...
| P1 | [M3-14 Recurring session series foundation](M3-14-RECURRING-SESSION-SERIES.md) | proposed — contract drafted | M3-13 accepted; ADR-017 accepted | Series schema, template, three change operations, and the owner-derived materializer that fills the fourteen-day window. **No UI**, on M3-10's precedent | Contract drafted and split 19 Aug 2026 against [ADR-017](../../decisions/ADR-017-RECURRENCE-MATERIALIZATION.md), which supersedes ADR-016's recurrence paragraph and carries a matching F-005 amendment. Tier 1 dispatch not approved. No 390px pass — nothing is visible until M3-14B |
| P1 | [M3-14B Recurring series surface](M3-14B-RECURRING-SERIES-SURFACE.md) | proposed | M3-14 accepted | Create and review a series, only-this and this-and-future edit scopes, end a series, the honest pending top-up state, and the 390px flow | Created by the 19 Aug 2026 split. Tier 2 on M3-14's accepted boundary; re-tier to 1 on any schema, grant, policy, or privileged-function change. Dispatch not approved and cannot precede M3-14 acceptance |
