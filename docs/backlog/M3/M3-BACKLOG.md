...
| P1 | [M3-14B Recurring series surface](M3-14B-RECURRING-SERIES-SURFACE.md) | in development | M3-14 accepted | Create and review a series, only-this and this-and-future edit scopes, end a series, the honest pending top-up state, and the 390px flow | Corrected Tier 2 contract and dispatch approved 20 Aug 2026. Consequences precede future-series removal; exact counts follow success; the locked-survivor no-op is withheld. Re-tier to 1 on any schema, grant, policy, migration, or privileged-function change |
