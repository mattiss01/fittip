...
| P1 | [M3-11 Legacy training reset](M3-11-LEGACY-TRAINING-RESET.md) | accepted (implementation) | M3-10 accepted | Permanently delete old training records and remove their exclusive schema/runtime; preserve M3-10 and named non-training domains behind maintenance-safe routes | Implementation accepted 15 Aug 2026 against reviewed `ce14576`, green exact-SHA CI, and its matching Preview. The founder database cutover is **not** accepted and still requires explicit **Run the destructive cutover** confirmation at runbook step B3 |
...
| P2 | [M3-18 Residual focus-ring contrast](M3-18-RESIDUAL-FOCUS-RING-CONTRAST.md) | proposed | M3-11 accepted and merged | Goals, memory, and onboarding still paint a 1.92:1 focus ring against the 3:1 WCAG 2.2 SC 1.4.11 minimum; apply M3-11's `var(--ledger-ink)` treatment. Presentation only | Raised by M3-11 independent review (NEW-2) and left out of that ticket's scope deliberately. Tier 3 proposed; confirm the tier and approve dispatch separately |
