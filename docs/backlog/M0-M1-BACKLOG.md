...
**Planning state:** M0 foundation, M0-01, M0-02, M0-02-C1, and the reduced basic-auth M0-03 are accepted. Account recovery is separated into proposed M0-03B and remains required before external MVP use. Every later ticket remains blocked until its dependencies and linked approval gate are satisfied.
