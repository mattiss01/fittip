...
founder-hosted topology in ADR-007 are accepted. M0-06A is in development.
...
| P0 | [M0-06A Founder-hosted staging](M0-06A-FOUNDER-HOSTED-STAGING.md) | in development | M0-03 and M0-02-C1 accepted; ADR-007 accepted | Free Vercel plus separate Frankfurt Supabase founder staging; hosted signup closed; owner UUID allowlist; disposable owner/synthetic data; migration/RLS/390px hosted validation | Approved by product owner on 26 July 2026; Terra builder and independent review required; live `$0` confirmation precedes resource creation; acceptance required before hosted M1 |
