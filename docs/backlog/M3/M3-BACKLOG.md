...
| P1 | [M3-02 Roadmap proposal](M3-02-ROADMAP-PROPOSAL.md) | in development 10 Aug 2026 | M3-01B accepted and accepted M2 foundations | Owner-scoped structured high-level roadmap proposal with phases, milestones, uncertainty, review points, source versions, edit/reject/accept boundary; no detailed plan | All decisions approved; dispatched 10 Aug 2026. Remaining gate: the per-source context allocation, independent review, Preview, and acceptance |
