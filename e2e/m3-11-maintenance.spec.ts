...
// M3-15E reopened `/home/plan/roadmap` as a read surface. Those routes are no
// longer maintenance stubs; `e2e/m3-12-plan.spec.ts`,
// `e2e/m3-15b-today-and-logging.spec.ts` and `e2e/m3-15c-progress.spec.ts`
// own the first three. `/home/plan/proposal` is the last stub and is still
// asserted here; it is M3-16.
const routes = ["/home/plan/proposal"] as const;
