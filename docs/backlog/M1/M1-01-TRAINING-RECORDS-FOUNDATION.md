...
**Validation:** [Builder and review evidence](../../validation/M1/M1-01-VALIDATION.md)
...
**Hosted boundary:** [M0-06A accepted](../M0/M0-06A-FOUNDER-HOSTED-STAGING.md) for product-owner or synthetic data only
...
7. Produce `docs/validation/M1/M1-01-VALIDATION.md` only when the ticket becomes
   testable.
