...
| P1 | [M3-10 Rolling-plan foundation](M3-10-ROLLING-PLAN-FOUNDATION.md) | in development | F-005 approved; ADR-016 accepted; one-cutover exception authorized | Dormant owner-scoped rolling-plan identity, current planned-session state, atomic before/after change log, owner revision, RLS/grants/indexes, and concurrency; no UI, activation, old-data mutation, or AI | Approved and dispatched Tier 1 on 14 Aug 2026; distinct builder and reviewer, exact-commit CI, Preview, hosted migration evidence, and product-owner acceptance remain required |
