...
| P1 | [M3-15F Roadmap generation and privilege re-grant](M3-15F-ROADMAP-GENERATION.md) | proposed | M3-15E accepted | Re-grant the five roadmap RPCs M3-11 revoked, and wire generation, regeneration, edit, decline and acceptance through `coach-ai-service` | Tier 1: privilege re-grant plus a hosted founder migration the lead cannot produce. Split from M3-15E on 14 Sep 2026 so the privilege arrives with its caller. **Three decisions needed before dispatch**: whether a live provider call is authorized at last, whether acceptance splits off again, and what happens to M3-09 |
