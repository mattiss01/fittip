...
| P1 | [M3-14 Recurring session series](M3-14-RECURRING-SESSION-SERIES.md) | proposed — contract drafted | M3-13 accepted; ADR-017 approved | Constrained daily/weekly recurrence, occurrences materialized into the fourteen-day window, this-and-future successors, DST, locks, and history | Contract drafted 19 Aug 2026 against [ADR-017](../../decisions/ADR-017-RECURRENCE-MATERIALIZATION.md), which supersedes ADR-016's recurrence paragraph and carries a matching F-005 amendment. Tier 1 dispatch not approved; three open questions recorded in the ticket — whether to split it, whether active series are capped, and what the owner sees while the window tops up |
