...
**Ticket:** [M1-02](../../backlog/M1/M1-02-SELECTABLE-HORIZON-PLANNING.md)
...
- `src/server/training/past-plan-protection.ts` - canonicalizes accepted and
  ...
  before persistence.
- `docs/validation/M1/M1-02-VALIDATION.md` - persists this implementation manifest,
  evidence, commands, limitations, and reviewer checklist.
- `docs/validation/M1/evidence/M1-02-390x844.png` - captures the accepted version
