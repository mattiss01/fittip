...
**Status:** proposed — deferred until after the F-005 replacement closeout

**Dispatch state:** optional post-closeout enhancement. Rewrite it against a
...
post-closeout rewrite additionally depends on M3-17 accepted.
