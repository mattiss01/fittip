...
founder-hosted topology in ADR-007 and M0-06A are accepted.
...
| P0 | [M0-06A Founder-hosted staging](M0-06A-FOUNDER-HOSTED-STAGING.md) | accepted | M0-03 and M0-02-C1 accepted; ADR-007 accepted | Free Vercel plus separate Frankfurt Supabase founder staging; hosted signup closed; owner UUID allowlist; disposable owner/synthetic data; migration/RLS/390px hosted validation | Terra implementation, independent review, and hosted validation passed; accepted by the product owner on 27 July 2026 |
