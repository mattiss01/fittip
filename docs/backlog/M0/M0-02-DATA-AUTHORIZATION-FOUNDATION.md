...
Before product-owner acceptance, create `docs/validation/M0/M0-02-VALIDATION.md` with builder evidence and independent review. The precise decision requested is: **accept M0-02 as the local data/authorization foundation, or return focused corrections**.
