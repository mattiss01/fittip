...
6. Produce `docs/validation/M1/M1-03-VALIDATION.md` at testable status.
...
[M1-02/M1-03 integration validation](../../validation/M1/M1-02-M1-03-INTEGRATION-VALIDATION.md).
