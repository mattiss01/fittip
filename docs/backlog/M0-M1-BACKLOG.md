...
**Planning state:** M0 foundation, M0-01, M0-02, and M0-02-C1 are accepted. M0-03 is dependency-ready but remains draft until the product owner approves its revised username-free F-001 feature brief. Every later ticket remains blocked until its dependencies and linked approval gate are satisfied.
