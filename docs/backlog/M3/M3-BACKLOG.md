...
| P1 | [M3-15C Progress](M3-15C-PROGRESS.md) | proposed | M3-15B accepted | Restore `/home/progress` and `/home/progress/[id]`: planned-versus-actual kept separate, a paginated history slice, and the immutable planned snapshot | Tier 2. Nothing to display until completions can be written. Draft the exact contract and separately approve dispatch |
